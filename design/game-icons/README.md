...
Здесь лежат присланные иконки как есть: двенадцать штук 430×430 RGBA, по одной
...
| `checkers.png` | `assets/game-checkers.png` | Шашки |

Двенадцатая (шашки) приехала так же, как одиннадцатая, — квадратом 1254×1254 на
два мегабайта, — и точно так же лежит здесь приведённой к общему виду: уменьшенной
до 430 с телом, вписанным в 401 (у неё это 401×399). Резать её отдельно не
пришлось, она пришла одна в архиве вместе с листом доски
(`design/checkers-board/`).
