...
export function applyGlassSettings(rawTheme) {
    ...
    // Основа стекла объявляется ОТДЕЛЬНЫМ атрибутом и ставится здесь же, рядом
    // с переменными. Раньше палитра стекла бралась по data-theme, а он ставится
    // в другом месте: стоило им разойтись — светлые обои получали тёмные
    // панели, и «светлая» тема выглядела бурой. Теперь настройки и палитра
    // приезжают одним куском и разойтись не могут.
    root.dataset.glassBase = theme.base;
