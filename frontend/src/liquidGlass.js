...
// выше страницы (окно 500, ряд вкладок 520, меню 700, липкая шапка
// калькулятора 505 — ей z-index поднят в glass.css именно ради этого) и друг
// друга не перекрывают. Поисковая строка на главной — соблазнительная цель (под ней
...
const GLASS_SELECTOR = '.app-tabs-inner, .modal-win, .theme-menu, .calc-topbar';
