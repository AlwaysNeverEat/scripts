...
// Ручка живёт в настройках профиля (шестерёнка на обложке, profileSettings.js),
// в том же разделе «Оформление», что и акцент, и по тем же правилам: выбор
// лежит в localStorage, то есть НА УСТРОЙСТВЕ, а не в аккаунте. Это оформление рабочего места, а не настройка человека: за одним
