// Чайник из Юты — чужой файл, из примеров three.js (examples/js/geometries/
// TeapotBufferGeometry.js, r98), тот же, что лежит в lib/ у самой заставки
// (github.com/1j01/pipes). Изменено РОВНО ДВА МЕСТА: глобальный THREE заменён
// импортом, а конструктор — экспортом. Больше ничего трогать нельзя: это
// тесселяция патчей Ньюэлла, и «поправить на глаз» тут ничего не выйдет.
// Происхождение и лицензии — design/pipes/README.md.
...
export function TeapotBufferGeometry( size, segments, bottom, lid, body, fitLid, blinn ) {
