...
// что такое тетрис.
//
// Модули игр грузятся ПО КЛИКУ, а не при открытии меню: пять игр — это пять
// чанков со своими правилами, словарями и спрайтом, и качать их все ради того,
// что откроют один, незачем. Само меню тянет только иконки.
//
