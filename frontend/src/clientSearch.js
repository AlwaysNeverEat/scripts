// ─────────────────────────────────────────────────────────────────────────────
// Вкладка «Клиент» (#/client): поиск человека в CRM по телефону или гос. номеру
// и ОДНА карточка на весь его след в базе — имя, баллы, машины и все чеки.
// Начиналась как третий режим строки поиска на главной; вынесена в свою
// вкладку — карточка клиента это отдельная работа, а не вариант поиска машины.
//
