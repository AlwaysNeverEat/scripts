...
| **Подписка supp** (тема «Жидкое стекло», плашка у ника) | `frontend/src/supporter.js` + `backend/src/supporter/` | Рабочая: выдаёт владелец вручную, гаснет сама через 30 дней |
