...
8. Автозаполнение базы: краулер (Motul → объёмы, MANN → 3 фильтра + кузов) кладёт
   черновики в фид «Добавить машины» на сайте; оператор правит карточку и жмёт
   «Добавить в БД» либо «Удалить». См. `tools/crawler/`.
