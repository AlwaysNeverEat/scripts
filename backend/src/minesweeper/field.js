...
//
// Логика живёт на сервере целиком: клиент шлёт «открыть клетку», сервер
// отвечает тем, что открылось, а где мины — говорит только в конце игры. Так
// партия переживает перезагрузку страницы, и заодно поле не подсматривается в
// консоли — иначе играть в него незачем.
//
