// ─────────────────────────────────────────────────────────────────────────────
// SPOT CRM «Пересчёт чека» — glue. Каталог масел и цены живут в shared/oils.js,
// файл *.user.js собирается автоматически (tools/build-userscript.mjs).
// ─────────────────────────────────────────────────────────────────────────────

import {
    getShopOils,
    getDefaults as sharedGetDefaults,
} from '../../../shared/oils.js';

// Этому скрипту нужен другой формат defaults: ATF — плоским списком,
// в том же порядке, что и раньше (ZIC Multi, ROLF Dexron VI, ROLF Multi).
function getDefaults() {
    const d = sharedGetDefaults();
