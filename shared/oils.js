...
export function getShopOils() { return [
    // Liqui Moly
    { b:'Liqui Moly', n:'5W-30 Top Tec', price:2500, v:'5W-30',
    ...
    { b:'Liqui Moly', n:'Leichtlauf HC 7 5W-30', price:2050, v:'5W-30',
    ...
    { b:'Liqui Moly', n:'5W-30 Molygen', price:2450, v:'5W-30',
    ...
    { b:'Liqui Moly', n:'5W-40 Molygen', price:2250, v:'5W-40',
      ...
      ad:['Америка/Азия','износ','отложения','топливо','масло-угар','антифрикционные'] },
    // ROLF
    { b:'ROLF', n:'Professional 5W-30 A5/B5', price:1550, v:'5W-30',
    ...
    { b:'ROLF', n:'Professional AM 5W-40', price:1750, v:'5W-40',
    ...
    { b:'ROLF', n:'Professional 5W-30 C3', price:1750, v:'5W-30',
    ...
    { b:'ZIC', n:'ZERO 0W-30', price:2150, v:'0W-30',
      a:['ACEA C3','VW 504 00','VW 507 00'],
      ad:['отложения','нагар','топливо'] },
    // GM / Shell / Castrol
    { b:'GM', n:'5W-30 Dexos II', price:1650, v:'5W-30',
    ...
    { b:'Shell', n:'5W-30 Ultra AM-L Kia/Hyundai', price:2100, v:'5W-30',
    ...
    { b:'Motul', n:'5W-30 SAVE-NERGY', price:2150, v:'5W-30',
...
export function getDefaults() { return {
    ...
    atf: {
        ...
        rolfDexron6: {
            b:'ROLF', n:'ATF Dexron VI', price:1750, v:'ATF', _type:'dexron6',
        ...
        rolfMulti: {
            b:'ROLF', n:'Professional ATF Multi', price:1750, v:'ATF', _type:'multi',
