...
export const STATIONS_META = [
    ...
    { match: 'Ветеранов 167',       short: 'Ветеранов 167к8',         metro: 'Пр. Ветеранов',     line: 1, boxNo: '##36', boxes: 2, layout: '2 бокса / 1 подъёмник',          height: '2.4 м', hydro: false,            lat: 59.835846, lng: 30.116537, knownId: '192', note: 'Сосновая Поляна' },
    ...
    { match: 'Советский 55',        short: 'Советский 55к2',          metro: 'Рыбацкое',          line: 3, boxNo: '##11', boxes: 2, layout: '2 бокса / 1 подъёмник',          height: '2.9 м', hydro: true,  ac: true,  lat: 59.825058, lng: 30.552574, knownId: '11', note: 'Металлострой' },
    ...
    { match: 'Дальневосточный',     short: 'Дальневосточный 3а',      metro: 'Пр. Большевиков',   line: 4, boxNo: '##07', boxes: 2, layout: '2 бокса (работает 1) / 1 яма',   height: '2.5 м', hydro: false, ac: true,  lat: 59.917727, lng: 30.425183, knownId: '133' },
    ...
    { match: 'Оптиков 2',           short: 'Оптиков 2',               metro: 'Комендантский пр.', line: 5, boxNo: '##04', boxes: 3, layout: '3 бокса / 1 подъёмник / 2 ямы',  height: '2.3 м', hydro: true,  ac: true,  lat: 59.995075, lng: 30.254630, knownId: '3' },
